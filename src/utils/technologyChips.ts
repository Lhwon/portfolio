...
const technologyStyles: Record<string, TechnologyChipStyle> = {
  ...
  devExpress: { backgroundColor: '#ffedd5', color: '#9a3412' },
  EChart: { backgroundColor: '#fee2e2', color: '#991b1b' },
  EmbeddingGemma: { backgroundColor: '#ede9fe', color: '#5b21b6' },
  Flutter: { backgroundColor: '#dbeafe', color: '#075985' },
  FastAPI: { backgroundColor: '#ccfbf1', color: '#0f766e' },
  fl_chart: { backgroundColor: '#fee2e2', color: '#991b1b' },
  GoRouter: { backgroundColor: '#e0e7ff', color: '#3730a3' },
  Gemma: { backgroundColor: '#ede9fe', color: '#5b21b6' },
  ...
  Jasper: { backgroundColor: '#fee2e2', color: '#991b1b' },
  ...
  Ollama: { backgroundColor: '#f1f5f9', color: '#111827' },
  'OZ Report': { backgroundColor: '#fee2e2', color: '#991b1b' },
  PostgreSQL: { backgroundColor: '#dbeafe', color: '#1e3a8a' },
  Python: { backgroundColor: '#dbeafe', color: '#1e40af' },
  'Qwen-VL': { backgroundColor: '#fce7f3', color: '#9d174d' },
  RAG: { backgroundColor: '#ede9fe', color: '#5b21b6' },
  RealGrid: { backgroundColor: '#ede9fe', color: '#5b21b6' },
  ...
  SQLite: { backgroundColor: '#dbeafe', color: '#075985' },
  ...
  Vuetify: { backgroundColor: '#dbeafe', color: '#075985' },
  'Vector DB': { backgroundColor: '#cffafe', color: '#155e75' },
...
const technologyIcons: Record<string, string> = {
  ...
  devExpress: 'mdi-view-grid-plus-outline',
  EChart: 'mdi-chart-box-outline',
  EmbeddingGemma: 'mdi-vector-point',
  Flutter: 'mdi-flutter',
  FastAPI: 'mdi-api',
  ...
  Jasper: 'mdi-file-chart-outline',
  MariaDB: 'mdi-database',
  MES: 'mdi-factory',
  'Mobile UI': 'mdi-cellphone',
  MSSQL: 'mdi-database',
  Oracle: 'mdi-database',
  Ollama: 'mdi-robot-outline',
  'OZ Report': 'mdi-file-pdf-box',
  PostgreSQL: 'mdi-database',
  Python: 'mdi-language-python',
  'Qwen-VL': 'mdi-image-search-outline',
